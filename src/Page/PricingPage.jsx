  ...
  return (
    <div className="bg-[#030712] min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        {/* WHY PARTNER WITH US */}
        <section className="py-20 px-7 md:px-10 container mx-auto max-w-7xl border-t border-white/5 mt-10">
        ...
        {/* CONTACT FORM */}
        <section className="py-24 px-7 md:px-10 container mx-auto max-w-4xl border-t border-white/5 mt-10">
